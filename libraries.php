...
/* Include CSS and Script */
   add_action('wp_enqueue_scripts','CCC__plugin_css_jsscripts');
   function CCC__plugin_css_jsscripts() {
      // CSS
...
if (!function_exists('CCC__register_script'))
{
    ...
    function CCC__register_script()
    {
        ...
        wp_register_style('boostrap_css', plugins_url('assets/css/bootstrap-min.css', __FILE__) , false, '5.2.3', 'all');
